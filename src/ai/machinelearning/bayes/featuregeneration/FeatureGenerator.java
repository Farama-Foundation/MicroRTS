...
public abstract class FeatureGenerator {
    ...
    public static void writeARFFHeader(List<List<Object>> features, List<String> labels,
        String name, FileWriter fw) throws Exception {
        ...
        for (int i = 0; i < nfeatures; i++) {
            ...
            if (instance.get(i) instanceof String) {
                ...
                for (List<Object> instance2 : features) {
                    if (!values.contains(instance2.get(i))) {
                        values.add((String) instance2.get(i));
                    }
                }
    ...
    public static void translateToARFF(List<Object> features, String label, FileWriter fw)
        throws Exception {
