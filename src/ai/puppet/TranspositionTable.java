...
class TranspositionTable {
    ...
    void store(PuppetGameState origState, Move bestMove, float value, float alpha, float beta,
        int height) {
        boolean exact, upper;
        if (value <= alpha) {
            exact = false;
    ...
    void store(PuppetGameState origState, int depth, Move move, Move bestMove, float value,
