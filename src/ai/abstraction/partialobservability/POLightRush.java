 ...
 * @author santi
 */
public class POLightRush extends LightRush {

    public POLightRush(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    
    public POLightRush(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_utt, a_pf);
    }
