...
public class UCTNode {
    ...
    public UCTNode(int maxplayer, int minplayer, GameState a_gs, UCTNode a_parent, float bound)
        throws Exception {
        parent = a_parent;
        gs = a_gs;
        if (parent == null) {
    ...
    public UCTNode UCTSelectLeaf(int maxplayer, int minplayer, long cutOffTime, int max_depth)
        throws Exception {
        ...
        if (hasMoreActions) {
            ...
            if (a != null) {
                ...
                UCTNode node = new UCTNode(maxplayer, minplayer, gs2.clone(), this,
                    evaluation_bound);
                children.add(node);
                return node;
            } else {
