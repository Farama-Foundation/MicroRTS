...
public class UCTUnitActions extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public UCTUnitActions(int available_time, int available_playouts, int lookahead, int max_depth,
    ...
    public void startNewComputation(int a_player, GameState gs) {
        ...
        tree = new UCTUnitActionsNode(playerForThisComputation, 1 - playerForThisComputation, gs,
    ...
    public void computeDuringOneGameFrame() throws Exception {
        ...
        while (true) {
            UCTUnitActionsNode leaf = tree
                .UCTSelectLeaf(playerForThisComputation, 1 - playerForThisComputation,
                    MAX_TREE_DEPTH);
