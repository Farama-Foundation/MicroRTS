...
public class UCT extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public UCT(int available_time, int max_playouts, int lookahead, int max_depth, AI policy,
    ...
    public void startNewComputation(int a_player, GameState gs) throws Exception {
        ...
        tree = new UCTNode(playerForThisComputation, 1 - playerForThisComputation, gs, null,
            evaluation_bound);
        gs_to_start_from = gs;
        total_runs_this_move = 0;
