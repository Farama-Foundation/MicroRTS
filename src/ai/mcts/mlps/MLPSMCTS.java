...
public class MLPSMCTS extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public MLPSMCTS(int available_time, int max_playouts, int lookahead, int max_depth, double a_C,
    ...
    public AI clone() {
        return new MLPSMCTS(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAX_TREE_DEPTH, C,
            randomAI, ef);
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "(" + TIME_BUDGET + ", " + ITERATIONS_BUDGET + ", "
            + MAXSIMULATIONTIME + ", " + MAX_TREE_DEPTH + ", " + C + ", " + randomAI + ", " + ef
            + ")";
    }
    ...
    public void startNewComputation(int a_player, GameState gs) throws Exception {
        ...
        tree = new MLPSNode(playerForThisComputation, 1 - playerForThisComputation, gs, null,
            evaluation_bound, current_iteration++);
    ...
    public PlayerAction getBestActionSoFar() {
        ...
        if (DEBUG >= 1) {
            ...
            System.out.println("MLPSMCTS selected children " + tree.actions.get(idx) + " explored "
