...
public class NaiveMCTSNode extends MCTSNode {
    ...
    // Naive Sampling:
    public NaiveMCTSNode selectLeaf(int maxplayer, int minplayer, float epsilon_l, float epsilon_g,
        float epsilon_0, int global_strategy, int max_depth, int a_creation_ID) throws Exception {
    ...
    public NaiveMCTSNode selectLeafUsingLocalMABs(int maxplayer, int minplayer, float epsilon_l,
        ...
        if (pate == null) {
            ...
            NaiveMCTSNode node = new NaiveMCTSNode(maxplayer, minplayer, gs2.clone(), this,
                evaluation_bound, a_creation_ID, forceExplorationOfNonSampledActions);
