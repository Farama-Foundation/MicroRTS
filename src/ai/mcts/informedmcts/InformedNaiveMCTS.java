...
public class InformedNaiveMCTS extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public InformedNaiveMCTS(UnitTypeTable a_utt) throws Exception {
        this(100, -1, 100, 10, 0.3f, 0.0f, 0.4f, new UnitActionProbabilityDistributionAI(
                new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                    .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-WR.xml")
                    .getRootElement(), a_utt,
                    new ActionInterdependenceModel(null, 0, 0, 0, a_utt, new FeatureGeneratorSimple(),
                        ""), "AIM-WR"), a_utt, "ActionInterdependenceModel-Acc-WR"),
            new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-WR.xml")
                .getRootElement(), a_utt,
                new ActionInterdependenceModel(null, 0, 0, 0, a_utt, new FeatureGeneratorSimple(),
    ...
    public InformedNaiveMCTS(int available_time, int max_playouts, int lookahead, int max_depth,
        float e1, float e2, float e3, AI policy, UnitActionProbabilityDistribution a_bias,
        EvaluationFunction a_ef, UnitTypeTable a_utt) {
    ...
    public InformedNaiveMCTS(int available_time, int max_playouts, int lookahead, int max_depth,
        float e1, float e2, float e3, int a_global_strategy, AI policy,
        UnitActionProbabilityDistribution a_bias, EvaluationFunction a_ef) {
        super(available_time, max_playouts);
        MAXSIMULATIONTIME = lookahead;
        playoutPolicy = policy;
        bias = a_bias;
    ...
    public List<ParameterSpecification> getParameters() {
        ...
        try {
            String[] biasNames = {"AIM-WR", "AIM-LR", "AIM-HR", "AIM-RR", "AIM-LSI500",
                "AIM-LSI10000", "AIM-NaiveMCTS500", "AIM-NaiveMCTS10000",};
            UnitActionProbabilityDistribution[] biasOptions = {
                new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                    .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-WR.xml")
                    .getRootElement(), utt,
                    new ActionInterdependenceModel(null, 0, 0, 0, utt, new FeatureGeneratorSimple(),
                        ""), "AIM-WR"), new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-LR.xml")
                .getRootElement(), utt,
                new ActionInterdependenceModel(null, 0, 0, 0, utt, new FeatureGeneratorSimple(),
                    ""), "AIM-LR"), new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-HR.xml")
                .getRootElement(), utt,
                new ActionInterdependenceModel(null, 0, 0, 0, utt, new FeatureGeneratorSimple(),
                    ""), "AIM-HR"), new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-RR.xml")
                .getRootElement(), utt,
                new ActionInterdependenceModel(null, 0, 0, 0, utt, new FeatureGeneratorSimple(),
                    ""), "AIM-RR"), new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-LSI500.xml")
                .getRootElement(), utt,
                new ActionInterdependenceModel(null, 0, 0, 0, utt, new FeatureGeneratorSimple(),
                    ""), "AIM-LSI500"), new BayesianModelByUnitTypeWithDefaultModel(new SAXBuilder()
                .build("data/bayesianmodels/pretrained/ActionInterdependenceModel-LSI10000.xml")
                .getRootElement(), utt,
                new ActionInterdependenceModel(null, 0, 0, 0, utt, new FeatureGeneratorSimple(),
                    ""), "AIM-LSI10000"), new BayesianModelByUnitTypeWithDefaultModel(
                new SAXBuilder().build(
                    "data/bayesianmodels/pretrained/ActionInterdependenceModel-NaiveMCTS500.xml")
                    .getRootElement(), utt,
                new ActionInterdependenceModel(null, 0, 0, 0, utt, new FeatureGeneratorSimple(),
                    ""), "AIM-NaiveMCTS500"), new BayesianModelByUnitTypeWithDefaultModel(
                new SAXBuilder().build(
            ...
            ParameterSpecification dp_ps = new ParameterSpecification("DefaultPolicy", AI.class,
                playoutPolicy);
            ParameterSpecification tpb_ps = new ParameterSpecification("TreePolicyBias",
                UnitActionProbabilityDistribution.class, bias);
            for (int i = 0; i < biasOptions.length; i++) {
                dp_ps.addPossibleValue(
                    new UnitActionProbabilityDistributionAI(biasOptions[i], utt, biasNames[i]));
