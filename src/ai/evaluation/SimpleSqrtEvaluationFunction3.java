 ...
 * @author santi
 * <p>
 * This function uses the same base evaluation as SimpleSqrtEvaluationFunction and
 * SimpleSqrtEvaluationFunction2, but returns the (proportion*2)-1 of the total score on the board
 * that belongs to one player. The advantage of this function is that evaluation is bounded between
 * -1 and 1.
 */
    ...
    public float base_score(int player, GameState gs) {
        ...
        for (Unit u : pgs.getUnits()) {
            if (u.getPlayer() == player) {
                ...
                score += UNIT_BONUS_MULTIPLIER * u.getCost() * Math
