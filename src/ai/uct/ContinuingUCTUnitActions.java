...
public class ContinuingUCTUnitActions extends AI {
    ...
    public ContinuingUCTUnitActions(int available_time, int lookahead, AI policy) {
    ...
    public AI clone() {
        return new ContinuingUCTUnitActions(TIME_PER_CYCLE, MAXSIMULATIONTIME, randomAI);
    }  
