...
/**
 * Basic AI class for any microRTS controller. In other words, any microRTS controller is a subclass
 * of this class, either directly or indirectly via other basic AI classes.
 *
 * @author santi
 */
public abstract class AI {
     ...
     * the player index to return the calculated {@link PlayerAction}.
     *
     ...
     * @return the PlayerAction stores a collection of {@link UnitAction} per {@link Unit}. Each of
     * these pairs indicate an assignment of an action to a unit
     * @throws Exception
     */
    ...
    /**
     * This function is also for implementing pre-game reasoning with the possibility of reading
     * from and writing to disc, in the specified directory.
     *
     * @param gs              the initial state of the game about to be played. Even if the game is
     *                        partially observable, the game state received by this function might
     *                        be fully observable
     * @param milliseconds    milliseconds time limit to perform the analysis. If zero, you can take
     *                        as long as you need
