 ...
 * @author santi
 * 
 * This class implements the diea of "randomized alpha-beta" search form Michael Buro's group into RTMM
 * 
 */
...
//            System.out.println("Basic Search suggested action: " + bestMove);
        ...
        if (!(System.currentTimeMillis() - startTime < availableTime)) return bestMove;
