...
public class PhysicalGameState {
    ...
    /**
     * Sets a new width. This do not change the terrain array, remember to change that when 
    ...
    /**
     * Sets a new height. This do not change the terrain array, remember to change that when 
     * you change the map width or height
     * @param h
     */
    ...
    /**
     * Returns the winner of the game, given the unit counts or -1 if the game is not over
	 ...
	 * The game is over when a player has zero units
	 * @return
	 */
	boolean gameover() {
		int unitcounts[] = new int[players.size()];
    ...
    /**
     * Clone the physical game state, but does not clone the units
     * The terrain is shared amongst all instances, since it never changes
     * @return
     */
    ...
    /**
     * This function tests if two PhysicalGameStates are identical 
     * (I didn't name this method "equals" since I don't want Java to use it)
     * @param pgs
     * @return
     */
