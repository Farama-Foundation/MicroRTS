...
public class PretrainNaiveBayesModels {
    ...
    public static void main(String[] args) throws Exception {
        pretrain("data/bayesianmodels/trainingdata/learning-traces-500", "AI0",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-WR.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
        pretrain("data/bayesianmodels/trainingdata/learning-traces-500", "AI1",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-LR.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
        pretrain("data/bayesianmodels/trainingdata/learning-traces-500", "AI2",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-HR.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
        pretrain("data/bayesianmodels/trainingdata/learning-traces-500", "AI3",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-RR.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
        pretrain("data/bayesianmodels/trainingdata/learning-traces-500", "AI4",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-LSI500.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
        pretrain("data/bayesianmodels/trainingdata/learning-traces-500", "AI5",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-NaiveMCTS500.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
        pretrain("data/bayesianmodels/trainingdata/learning-traces-10000", "AI4",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-LSI10000.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
        pretrain("data/bayesianmodels/trainingdata/learning-traces-10000", "AI5",
            "data/bayesianmodels/pretrained/ActionInterdependenceModel-NaiveMCTS10000.xml",
            ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE, new FeatureGeneratorSimple());
    }

    public static void pretrain(String tracesFolder, String AIname, String outputFileName,
        int model_type, FeatureGenerator fg) throws Exception {
        ...
        if (model_type == CALIBRATED_NAIVE_BAYES) {
            model = new CalibratedNaiveBayes(Xsizes, allPossibleActions.size(),
                BayesianModel.ESTIMATION_LAPLACE, 0.0, utt, fg, "CNB");
        } else if (model_type == ACTION_INTERDEPENDENCE_MODEL) {
            model = new ActionInterdependenceModel(Xsizes, allPossibleActions.size(),
                BayesianModel.ESTIMATION_LAPLACE, 0.0, utt, fg, "AIM");
        } else if (model_type == CALIBRATED_NAIVE_BAYES_BY_UNIT_TYPE) {
            model = new BayesianModelByUnitTypeWithDefaultModel(utt,
                new CalibratedNaiveBayes(Xsizes, allPossibleActions.size(),
                    BayesianModel.ESTIMATION_LAPLACE, 0.0, utt, fg, "CNB"), "CNB");
        } else if (model_type == ACTION_INTERDEPENDENCE_MODEL_BY_UNIT_TYPE) {
            model = new BayesianModelByUnitTypeWithDefaultModel(utt,
                new ActionInterdependenceModel(Xsizes, allPossibleActions.size(),
                    BayesianModel.ESTIMATION_LAPLACE, 0.0, utt, fg, "AIM"), "AIM");
        }
    ...
    public static List<TrainingInstance> generateInstances(String tracesFolder, String targetAIID)
        throws Exception {
        ...
        for (File file : folder.listFiles()) {
            ...
            if (fileName.endsWith(".xml")) {
                ...
                if (ai1.equals(targetAIID)) {
                    playerToLearnFrom = 0;
                }
                if (ai2.equals(targetAIID)) {
                    playerToLearnFrom = 1;
                }
                        ...
                        for (Pair<Unit, UnitAction> tmp : te.getActions()) {
                            if (tmp.m_a.getUnitActions(gs).size() > 1) {
                                if (tmp.m_a.getPlayer() == playerToLearnFrom) {
                                    TrainingInstance ti = new TrainingInstance(gs, tmp.m_a.getID(),
                                        tmp.m_b);
