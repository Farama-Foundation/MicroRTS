 ...
 public class MapVisualizationTest {
     ...
     public static void main(String[] args) throws Exception {
         ...
         PhysicalGameState pgs = PhysicalGameState
             .load("maps/8x8/basesWorkers8x8Obstacle.xml", utt);
         ...
         JFrame w2 = PhysicalGameStatePanel
             .newVisualizer(new PartiallyObservableGameState(gs, 0), 640, 640, true);
         JFrame w3 = PhysicalGameStatePanel
             .newVisualizer(gs, 640, 640, false, PhysicalGameStatePanel.COLORSCHEME_WHITE);
     }
 }
