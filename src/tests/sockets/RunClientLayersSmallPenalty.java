 ...
 * 
 */
public class RunClientLayersSmallPenalty {
    public static void main(String args[]) throws Exception {
        ...
        SocketRewardPenaltyOnInvalidActionAI srai = new SocketRewardPenaltyOnInvalidActionAI(100, 0, serverIP, serverPort,
                SocketRewardPenaltyOnInvalidActionAI.LANGUAGE_JSON, utt, layerJSON);
